...
#PBS -N 11_bhh_gd_only_baseline
#PBS -q serial
#PBS -P CSCI0886
#PBS -l select=1:ncpus=24:mem=120gb:ngpus=0
#PBS -l walltime=48:00:00
#PBS -o /mnt/lustre/users/aschreuder/revised/11_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/11_stderror.err
...
bash experiments/scripts/bhh_gd_only_baseline.sh
