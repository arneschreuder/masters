...
#PBS -o /mnt/lustre/users/aschreuder/11_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/11_stderror.err
...
bash experiments/scripts/bhh_gd_only_baseline_scripts.sh
