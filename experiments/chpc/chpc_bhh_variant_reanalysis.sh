...
#PBS -o /mnt/lustre/users/aschreuder/revised/7_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/7_stderror.err
...
bash experiments/scripts/bhh_variant_reanalysis.sh
