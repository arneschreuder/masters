...
#PBS -o /mnt/lustre/users/aschreuder/revised/9_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/9_stderror.err
...
bash experiments/scripts/bhh_variant_reselection.sh
