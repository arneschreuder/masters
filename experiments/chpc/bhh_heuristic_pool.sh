...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/bhh_hp.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderror/bhh_hp.err
...
bash experiments/scripts/bhh_heuristic_pool.sh
