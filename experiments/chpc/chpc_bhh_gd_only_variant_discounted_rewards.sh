...
#PBS -o /mnt/lustre/users/aschreuder/14_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/14_stderror.err
...
bash experiments/scripts/bhh_gd_only_variant_discounted_rewards_scripts.sh
