...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/again.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderr/again.err
...
bash experiments/scripts/again10.sh
