...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/bhh_dr.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderror/bhh_dr.err
...
bash experiments/scripts/bhh_discounted_rewards.sh
