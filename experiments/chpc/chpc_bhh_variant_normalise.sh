...
#PBS -o /mnt/lustre/users/aschreuder/revised/5_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/5_stderror.err
...
bash experiments/scripts/bhh_variant_normalise.sh
