...
#PBS -o /mnt/lustre/users/aschreuder/revised/2_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/2_stderror.err
...
bash experiments/scripts/bhh_variant_burn_in.sh
