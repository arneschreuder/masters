...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/bhh_ra.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderror/bhh_ra.err
...
bash experiments/scripts/bhh_reanalysis.sh
