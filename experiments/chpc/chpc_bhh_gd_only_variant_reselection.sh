...
#PBS -o /mnt/lustre/users/aschreuder/19_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/19_stderror.err
...
bash experiments/scripts/bhh_gd_only_variant_reselection_scripts.sh
