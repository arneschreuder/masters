...
#PBS -o /mnt/lustre/users/aschreuder/21_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/21_stderror.err
...
bash experiments/scripts/bhh_gd_only_log_all_scripts.sh
