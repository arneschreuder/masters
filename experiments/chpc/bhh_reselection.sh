...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/bhh_rs.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderror/bhh_rs.err
...
bash experiments/scripts/bhh_reselection.sh
