...
#PBS -o /mnt/lustre/users/aschreuder/tracking/stdin/bhh_ct.out
#PBS -e /mnt/lustre/users/aschreuder/tracking/stderror/bhh_ct.err
...
bash experiments/scripts/bhh_credit.sh
