...
#PBS -o /mnt/lustre/users/aschreuder/revised/8_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/8_stderror.err
...
bash experiments/scripts/bhh_variant_replay.sh
