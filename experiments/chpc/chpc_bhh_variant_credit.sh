...
#PBS -o /mnt/lustre/users/aschreuder/revised/3_stdoutput.out
#PBS -e /mnt/lustre/users/aschreuder/revised/3_stderror.err
...
bash experiments/scripts/bhh_variant_credit.sh
