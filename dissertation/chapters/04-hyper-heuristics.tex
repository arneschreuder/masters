...
\begin{itemize}
      ...
      \item \textbf{Section \ref{sec:hh:classification}} provides a detailed discussion on the classification and types of \acp{HH}. Distinction is made between online and offline learning mechanisms. Discussions follow on selection and generation \acp{HH}, and constructive and generative mechanisms.

      \item \textbf{Section \ref{sec:hh:summary}} provides a summary of the chapter.
\end{itemize}
