...
\begin{figure}[htb]
      ...
      \caption{The \acfp{PDF} for the \index{Dirichlet probability distribution}Dirichlet probability distribution over the 2-simplex. The concentration parameters, $\boldsymbol{\alpha}$, are varied. The values of the \acs{PDF} are shown by the colour maps with contour lines at equal values as indicated in the colour bars~\cite{ref:dirichlet:2020}.}
...
\begin{figure}[htb]
      ...
      \caption{The experimental outcomes for the mice-population experiments as were taken from~\cite{ref:hackenberger:2019} .}
