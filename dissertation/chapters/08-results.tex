...
% \begin{table}[htbp]
% 	\centering
% 	\caption{Empirical results showing average rank and statistics for normalisationnormalisation toggled by the \acs{BHH} across multiple datasets, for all runs and epochs.}
...
% \begin{table}[htbp]
% 	\centering
% 	\caption{Empirical results showing average rank and statistics for discounted rewardsdiscounted rewards toggled by the \acs{BHH} across multiple datasets, for all runs and epochs.}
...
% \section{Divergence}\label{sec:results:divergence}

% \begin{figure}[htbp]
% 	\begin{subfigure}{0.5\textwidth}
% 		\centering
% 		\includegraphics[width=\textwidth]{standalone/figures/train/loss/adult.pdf}
% 		\caption{Train log loss}
% 		\label{fig:results:divergence:figures:loss:train:adult}
% 	\end{subfigure}
% 	\begin{subfigure}{0.5\textwidth}
% 		\centering
% 		\includegraphics[width=\textwidth]{standalone/figures/test/loss/adult.pdf}
% 		\caption{Test log loss}
% 		\label{fig:results:divergence:figures:loss:test:adult}
% 	\end{subfigure}
% 	\par\bigskip
% 	\begin{subfigure}{0.5\textwidth}
% 		\centering
% 		\includegraphics[width=\textwidth]{standalone/figures/train/accuracy/adult.pdf}
% 		\caption{Train log accuracy}
% 		\label{fig:results:divergence:figures:accuracy:train:adult}
% 	\end{subfigure}
% 	\begin{subfigure}{0.5\textwidth}
% 		\centering
% 		\includegraphics[width=\textwidth]{standalone/figures/test/accuracy/adult.pdf}
% 		\caption{Test log accuracy}
% 		\label{fig:results:divergence:figures:accuracy:test:adult}
% 	\end{subfigure}
% 	\par\bigskip
% 	\caption{The train and test, loss and accuracy plot for the experimental group comparing the performance of the \acs{BHH} with different configurations for the burn in window size hyper-parameter on the adult dataset over 30 epochs, illustrated in log scale.}
% 	\label{fig:results:divergence:figures:adult}
% \end{figure}
