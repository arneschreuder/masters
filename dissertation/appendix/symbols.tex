...
\begin{description}
	...
	\item [\parbox{2cm}{$\mathcal{A}$}]
	\item [\parbox{2cm}{$\mathcal{L}$}]
	\item [\parbox{2cm}{$\overset{\text{iid}}{\sim}$}]
	\item [\parbox{2cm}{$\psi$}]
	\item [\parbox{2cm}{$\theta_{1}$}]
	\item [\parbox{2cm}{$\theta_{k}$}]
	\item [\parbox{2cm}{$\theta_{K}$}]
	\item [\parbox{2cm}{$\theta$}]
	\item [\parbox{2cm}{$A$}]
	\item [\parbox{2cm}{$B_{1}$}]
	\item [\parbox{2cm}{$B_{2}$}]
	\item [\parbox{2cm}{$B_{i}$}]
	\item [\parbox{2cm}{$B_{j}$}]
	\item [\parbox{2cm}{$B_{K}$}]
	\item [\parbox{2cm}{$B(\boldsymbol{\alpha})$}]
	\item [\parbox{2cm}{$B$}]
	\item [\parbox{2cm}{$Ber(\theta)$}]
	\item [\parbox{2cm}{$Beta$}]
	\item [\parbox{2cm}{$Bin$}]
	\item [\parbox{2cm}{$c$}]
	\item [\parbox{2cm}{$Cat$}]
	...
	\item [\parbox{2cm}{$Dir$}]
	\item [\parbox{2cm}{$dn$}]
	\item [\parbox{2cm}{$E[{x_{k}}]$}]
	\item [\parbox{2cm}{$E[\ln(x_{k})]$}]
	\item [\parbox{2cm}{$E[\ln(x)]$}]
	\item [\parbox{2cm}{$E[x_{k}]$}]
	\item [\parbox{2cm}{$E[x]$}]
	\item [\parbox{2cm}{$f_{Ber}$}]
	\item [\parbox{2cm}{$f_{Beta}$}]
	\item [\parbox{2cm}{$f_{Bin}$}]
	\item [\parbox{2cm}{$f_{Cat}$}]
	\item [\parbox{2cm}{$f_{Dir}$}]
	\item [\parbox{2cm}{$f_{Mul}$}]
	\item [\parbox{2cm}{$f$}]
	\item [\parbox{2cm}{$F$}]
	\item [\parbox{2cm}{$g^{*}$}]
	\item [\parbox{2cm}{$g$}]
	...
	\item [\parbox{2cm}{$k$}]
	\item [\parbox{2cm}{$K$}]
	\item [\parbox{2cm}{$M[x_{k}]$}]
	\item [\parbox{2cm}{$M[x]$}]
	\item [\parbox{2cm}{$m$}]
	\item [\parbox{2cm}{$M$}]
	\item [\parbox{2cm}{$Mul$}]
	\item [\parbox{2cm}{$N_{0}$}]
	\item [\parbox{2cm}{$N_{1}$}]
	...
	\item [\parbox{2cm}{$S$}]
	\item [\parbox{2cm}{$v$}]
	\item [\parbox{2cm}{$x_{1}$}]
	\item [\parbox{2cm}{$x_{i,k}$}]
	\item [\parbox{2cm}{$x_{i}$}]
	\item [\parbox{2cm}{$x_{I}$}]
	\item [\parbox{2cm}{$x_{j}$}]
	\item [\parbox{2cm}{$x_{k}$}]
	\item [\parbox{2cm}{$x_{K}$}]
	\item [\parbox{2cm}{$x$}]
	\item [\parbox{2cm}{$y_{1}$}]
	\item [\parbox{2cm}{$Y_{1}$}]
	\item [\parbox{2cm}{$y_{2}$}]
	\item [\parbox{2cm}{$Y_{2}$}]
	\item [\parbox{2cm}{$y_{i}$}]
	\item [\parbox{2cm}{$Y_{i}$}]
	\item [\parbox{2cm}{$y_{n}$}]
	\item [\parbox{2cm}{$Y_{N}$}]
\end{description}
...
\begin{description}
	...
	\item [\parbox{2cm}{$\gamma_{K}$}]
	\item [\parbox{2cm}{$\hat{\phi}_{j,k}$}]
	\item [\parbox{2cm}{$\hat{\psi_{k}}$}]
	\item [\parbox{2cm}{$\hat{\psi}_{k}$}]
	\item [\parbox{2cm}{$\hat{\theta_{k}}$}]
	\item [\parbox{2cm}{$\hat{\theta}_{k}$}]
	\item [\parbox{2cm}{$\lambda_{1}$}]
	\item [\parbox{2cm}{$\lambda_{j}$}]
	\item [\parbox{2cm}{$\lambda_{J}$}]
	\item [\parbox{2cm}{$\mathbbm{1}_{0}$}]
	\item [\parbox{2cm}{$\mathbbm{1}_{1}$}]
	\item [\parbox{2cm}{$\mathbin{\%}$}]
	\item [\parbox{2cm}{$\mathcal{A}(v)$}]
	\item [\parbox{2cm}{$\mathcal{L}$}]
	\item [\parbox{2cm}{$\phi_{j,k}$}]
	\item [\parbox{2cm}{$\phi_{jk}$}]
	\item [\parbox{2cm}{$\phi$}]
	\item [\parbox{2cm}{$\psi_{k}$}]
	\item [\parbox{2cm}{$\psi_{k}N_{k}$}]
	\item [\parbox{2cm}{$\psi$}]
	\item [\parbox{2cm}{$\theta_{k}$}]
	\item [\parbox{2cm}{$\theta$}]
	\item [\parbox{2cm}{$A$}]
	...
	\item [\parbox{2cm}{$c_{i,k}$}]
	\item [\parbox{2cm}{$c_{i}$}]
	\item [\parbox{2cm}{$Dir$}]
	\item [\parbox{2cm}{$e_{i,j,k}$}]
	\item [\parbox{2cm}{$e_{i}$}]
	\item [\parbox{2cm}{$e_{j}$}]
	\item [\parbox{2cm}{$E[\phi_{j,k}]$}]
	\item [\parbox{2cm}{$E[\psi_{k}]$}]
