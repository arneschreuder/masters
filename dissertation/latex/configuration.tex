...
% Graphics
\graphicspath{{./images/}{../analysis/}} % Include path for images
...
\hypersetup{
      pdftitle    = {Training Feedforward Neural Networks with Bayesian
                  Hyper-Heuristics},
      pdfauthor   = {A.N. Schreuder <an.schreuder@up.ac.za>},
      pdfsubject  = {Bayesian Hyper-Heuristics},
      pdfkeywords = {hyper-heuristics, meta-learning, feedforward neural networks, supervised learning, Bayesian statistics},
